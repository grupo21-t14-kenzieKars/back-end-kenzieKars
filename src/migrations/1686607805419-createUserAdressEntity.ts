...
export class CreateUserAdressEntity1686607805419 implements MigrationInterface {
    name = 'CreateUserAdressEntity1686607805419'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cars" ALTER COLUMN "fuel_type" DROP DEFAULT`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cars" ALTER COLUMN "fuel_type" SET DEFAULT 'Flex'`);
