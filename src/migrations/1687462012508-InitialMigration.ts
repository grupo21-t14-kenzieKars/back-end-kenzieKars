...
export class InitialMigration1687462012508 implements MigrationInterface {
    name = 'InitialMigration1687462012508'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "images" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "one" character varying NOT NULL, "two" character varying, "three" character varying, "four" character varying, "five" character varying, "six" character varying, "carId" uuid, CONSTRAINT "REL_c966d343d95687961368797192" UNIQUE ("carId"), CONSTRAINT "PK_1fe148074c6a1a91b63cb9ee3c9" PRIMARY KEY ("id"))`);
